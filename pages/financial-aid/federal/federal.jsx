  ...
  <div>
    ...
    <h2>Pell Grants</h2>
      ...
      <p>In 2011–12, the average grant for dependent full-time Pell recipients from families with incomes under $30,000 was $5,200.  </p>
       <Multiples title="Pell Grant by Dependency Status and Income, Full-Time Students, 2011–12 (with Percentage Receiving Pell)" subtitle= "Dollars per recipient" source="National Postsecondary Student Aid Study (NPSAS), 2012.">

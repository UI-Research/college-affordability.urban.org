  ...
  <div>
    ...
    <h2>Pell Grants</h2>
      ...
      <p>In 2011–12, the average grant for dependent full-time Pell recipients from families with incomes under $30,000 was $5,200.  </p>
       <Multiples title="Pell Grant by Dependency Status and Income, 2011–12 (with percentage receiving Pell)" subtitle= "Per recipient" source="National Postsecondary Student Aid Study (NPSAS), 2012." notes="Includes all full-time students, both Pell grant recipients and nonrecipients.">
        ...
        <Multiples title="" subtitle="Per full-time student" source="NPSAS, 2012" notes="Includes all full-time students, both Pell grant recipients and nonrecipients.">

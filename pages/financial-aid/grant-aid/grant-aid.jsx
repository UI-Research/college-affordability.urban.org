...
let singlepage = (
  ...
  <h2>By Income and Dependency Status</h2>
    ...
    <Multiples title="Grant Aid by Source for Independent and Dependent Students, by Sector, 2011–12" source="National Postsecondary Student Aid Study (NPSAS), 2012.">

...
let singlepage = (
  <div>
    <h1>Tax Benefits</h1>
      <p>Students and parents can recoup some of what they spend out of pocket through federal tuition tax credits and deductions. <strong>In 2016, about 12 million taxpayers got a break, averaging about $1,400 on their federal income taxes, because they were paying for college. Federal income taxes offset about $17 billion in tuition payments for students and their parents.</strong></p>
      <p>Tax benefits, unlike most financial aid, come long after the bills have been paid. When students or parents file taxes, they can report tuition and fees paid and receive their credit or deduction either as a reduction in the amount of taxes due or as a refund check.</p>
    ...
    <h2>By Income</h2>
      ...
      <Box>
        ...
        <p><em>Unlike tax credits, which directly reduce taxes owed, tax deductions&mdash;including </em><em>&mdash;diminish taxable income. The savings depend on the tax bracket in which the filer&rsquo;s income falls. Under current provisions, filers can deduct up to $4,000 a year in tuition and fee payments.</em></p>

  ...
  <div>
    <h1>State Grant Aid</h1>
      ...
      <Box>
        ...
        <p><em>Do the tuition set-aside grants come from tuition money? Or do they come from state appropriations that pass through the institutions to the recipients? There is no way to determine which dollars go to student aid and which dollars fund instructional costs.</em></p>
      </Box>

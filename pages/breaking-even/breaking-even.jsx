...
let singlepage = (
  ...
  <h1>Breaking Even</h1>
	...
	<p>The chart below is based on median earnings for each level of education. It incorporates the following assumptions that may differ from other similar analyses, such as those in the College Board&rsquo;s&nbsp;<a href="https://trends.collegeboard.org/education-pays" target="_blank"><strong><em>Education Pays</em></strong></a>&nbsp;publications:</p>
	<ul>
	...
	<p>Paying the average net tuition price at a private nonprofit four-year college for five years ($33,520for one year in 2017-18 instead of $17,027, which is the average for both public, private nonprofit, and for-profit &nbsp;four year&nbsp;college students), but still earning median income for bachelor&rsquo;s degree recipients, would&nbsp;<strong>raise the estimated break-even age from 31 to 37</strong>, still leaving about 30 years of the typical work life to reap the earnings premium.</p>
	<p>Paying the average net tuition price at a public four-year college for five years ($9,670 instead of $17,027) would&nbsp;<strong>lower the break-even age from 31 to 28</strong>.</p>
	...
	<p>Many students have earnings while they are in college. Working 800&nbsp;hours&nbsp;a year (35 hours/week for 12 weeks and 10 hours/week for 38 weeks) at the national minimum wage of $7.25/hour&nbsp;<strong>lowers the estimated break-even age</strong>&nbsp;for the median bachelor&rsquo;s degree recipient from age 31to age 26 and for the median associate degree recipient from 34 to 30.</p>

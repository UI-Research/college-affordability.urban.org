...
let singlepage = (
  ...
  <h1>Breaking Even</h1>
	...
	<p>Most students who earn bachelor&rsquo;s degrees will reach this break-even point about eight years after they graduate. But about 25 percent of adults with bachelor&rsquo;s degrees have earnings that are lower than the median for high school graduates and may never come out ahead financially.</p>
	...
	<p>The chart below is based on median earnings for each level of education. It incorporates the following assumptions that may differ from other similar analyses, such as those in the College Board&rsquo;s <a href="https://trends.collegeboard.org/education-pays"><em>Education Pays</em></a> publications: </p>
	<ul>
	...
	<p>About 25 percent of bachelor&rsquo;s degree recipients earn less than the median for high school graduates. In other words, some college graduates never end up financially better off than the median high school graduate. On the other hand, half of all bachelor&rsquo;s degree recipients earn more than the median earnings used in the calculations reported here.</p>
  </div>
);

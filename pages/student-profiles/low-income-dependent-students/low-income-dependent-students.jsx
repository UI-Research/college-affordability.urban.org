...
let specifications = {
  'name': 'low-income-dependent-students',
  'title': 'Low-Income Dependent Students',
  'content': <SinglePage content={singlepage} />
};

const LowIncomeDependentStudents = React.createClass({
  render: function() {
    return (
...
util.printToPage('low-income-dependent-students', LowIncomeDependentStudents);

module.exports = LowIncomeDependentStudents;

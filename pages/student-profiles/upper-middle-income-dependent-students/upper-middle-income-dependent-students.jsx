...
let singlepage = (
  <div>
    <h1>Upper-Middle Income Dependent Students</h1>
    <h2>Overview</h2>
...
let specifications = {
  'name': 'upper-middle-income-dependent-students',
  'title': 'Upper-Middle Income Dependent Students',
  'content': <SinglePage content={singlepage} />
};

const UpperMiddleIncomeDependentStudents = React.createClass({
  render: function() {
    return (
...
util.printToPage('upper-middle-income-dependent-students', UpperMiddleIncomeDependentStudents);

module.exports = UpperMiddleIncomeDependentStudents;

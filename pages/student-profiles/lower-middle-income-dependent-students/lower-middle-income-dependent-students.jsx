...
let singlepage = (
  <div>
    <h1>Lower-Middle Income Dependent Students</h1>
    <h2>Overview</h2>
...
let specifications = {
  'name': 'lower-middle-income-dependent-students',
  'title': 'Lower-Middle Income Dependent Students',
  'content': <SinglePage content={singlepage} />
};

const LowerMiddleIncomeDependentStudents = React.createClass({
  render: function() {
    return (
...
util.printToPage('lower-middle-income-dependent-students', LowerMiddleIncomeDependentStudents);

module.exports = LowerMiddleIncomeDependentStudents;

...
let singlepage = (
  <div>
    <h1>Upper Income Dependent Students</h1>
    <h2>Overview</h2>
...
let specifications = {
  'name': 'upper-income-dependent-students',
  'title': 'Upper Income Dependent Students',
  'content': <SinglePage content={singlepage} />
};

const UpperIncomeDependentStudents = React.createClass({
  render: function() {
    return (
...
util.printToPage('upper-income-dependent-students', UpperIncomeDependentStudents);

module.exports = UpperIncomeDependentStudents;

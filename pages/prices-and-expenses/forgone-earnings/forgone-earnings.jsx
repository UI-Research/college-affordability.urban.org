...
let singlepage = (
  <div>
    ...
    <h2>Earnings of High School Graduates in Recent Years</h2>
      ...
      <p>From 2009 to 2013, less than 30 percent of high school graduates ages 18–23—the ages of dependent undergraduates—who were not in school worked full time year-round. The most common pattern was working part time or part of the year. </p>
      ...
      <Multiples title="Median Earnings with 25th and 75th Percentiles among Full-Time Full-Year Workers Ages 18–34 with Only a High School Diploma or GED and Not in School, by Gender and Age" source="IPUMS 2014 ACS five-year sample (2010–14).">
        <Graph file={require('./json/03_1811.json')} small="true"/>
        <Graph file={require('./json/03_1812.json')} small="true"/>
      </Multiples>
      <Multiples title="Median Earnings with 25th and 75th Percentiles among Full-Time Full-Year Workers Ages 18–23 with Only a High School Diploma or GED and Not in School, by Gender and Race/Ethnicity" source="IPUMS 2014 ACS five-year sample (2010–14).">
        <Graph file={require('./json/03_1821.json')} small="true"/>
        <Graph file={require('./json/03_1822.json')} small="true"/>
      </Multiples>
      <Multiples title="Median Earnings with 25th and 75th Percentiles among Full-Time Full-Year Workers Ages 24–34 with Only a High School Diploma or GED and Not in School, by Gender and Race/Ethnicity" source="IPUMS 2014 ACS five-year sample (2010–14).">
    ...
    <h2>Earnings of High School Graduates Over Time</h2>
      ...
      <p>Because of the gaps in earnings by gender, it is important to look at men and women separately. From 1990 to 2014 for year-round full-time male workers ages 18 to 23, the highest median earnings (in 2014 dollars) were in 1998 ($27,595) and 2008 ($26,389). The lowest were in 2011 ($22,101) and 2012 ($22,684). By 2014, median earnings had risen to $25,000—still 9 percent below the 1998 level.</p>
      ...
      <p>The pattern for women has been a little different, but the story is similar. Median earnings for female high school graduates working full time year-round were 16 percent lower in inflation-adjusted dollars in 2014 than in 2002, declining from $23,687 (in 2014 dollars) to $20,000. Earnings for these women have not yet recovered from the impact of the Great Recession.</p>
      <p>Earnings among the 24- to 34-year-old age group have also declined in inflation-adjusted dollars from their levels in the 1990s and early 2000s. Median earnings among male high school graduates in this age group working full time year-round fell steadily from about $38,500 in 2000 to about $32,000 in 2000. Median earnings among women of the same age and work status fell from about $32,300 in 2002 to about $25,000 in 2014.</p>
  </div>
);

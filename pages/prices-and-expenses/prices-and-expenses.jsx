  ...
  <div>
    <h1>Prices and Expenses</h1>
		...
		<Box>
			...
			<p><em>There is no simple way for institutions to estimate how much money a typical student spends while attending college. Even if colleges could conduct reliable surveys of actual expenditures, it would not be possible to separate discretionary spending from necessities. For example, the average rent paid would incorporate both students who share studio apartments in poorly maintained buildings and those who live alone in high-priced, one-bedroom apartments. How many trips home per year should the transportation budget include? And should it be based on bus fares or plane fares? Is it reasonable to expect students to eat in the dining hall or cook all of their meals, or should the budget include pizza or more expensive restaurant meals several times a month?</em></p>
			<p><em>Institutions may also face incentives to over- or underestimate student budgets. A lower estimated cost of attendance makes the college look more affordable to prospective students, while a higher estimate will make some students eligible for larger federal loans or other forms of financial aid.</em></p></Box>
			<p>Additionally, most students don&rsquo;t end up paying the full cost of attendance, as these estimates do not account for financial aid. Most students get some assistance that lowers the <strong><a href="net-price">net price</a></strong> of going to college below the published sticker price. Because of this, the total estimated budget can be misleading, generating anxiety among students who will actually pay much lower net tuition prices. </p>
  </div>
);

...
let singlepage = (
  <div>
    <h1>Net price</h1>
        ...
        <p>Net prices vary quite a bit, even among students enrolled in the same college. Academic records, athletic abilities, and a variety of other factors can influence net price, but income is the most important factor, since it usually determines how much financial aid a student receives. Because low-income students typically receive more grant aid at high-price colleges than elsewhere, these schools can end up costing less for these students than schools with lower price tags. </p>

  ...
  <div>
    <h1>Tuition and Fees</h1>
		...
		<Box>
			...
			<p><em>The prices reported to the US </em><a href="https://nces.ed.gov/ipeds/" target="_blank"><strong><em>Department of Education</em></strong></a><em> and in the College Board&rsquo;s <strong><a href="https://trends.collegeboard.org/college-pricing" target="_blank">Trend in College Pricing</a></strong>&nbsp;</em><em>reports and reflected in the sectoral averages do not necessarily incorporate this complexity.</em></p>
		</Box>
	<h2>Tuition and Fees by Sector</h2>
		...
		<Box>
			...
			<p><em>The &ldquo;normal&rdquo; time to degree is four years for a bachelor&rsquo;s degree, two years for an associate degree, and less than two years for a certificate. If all students completed their degrees on time, the sticker price of an associate degree would be twice the annual tuition and fees, an average of $7,300 in community colleges and $28,000 in the for-profit sector in 2018&ndash;19. The sticker price of a bachelor&rsquo;s degree would be four times the annual tuition and fees, an average of $40,900 in the public sector and $143,300 in the private nonprofit sector.</em></p>
			<p><em>But many students take longer to earn their degrees. Some enroll part time and don&rsquo;t pay the full price every year. Others do not arrive academically prepared for college-level work and must take noncredit </em><a href="https://edreformnow.org/app/uploads/2016/04/EdReformNow-O-O-P-Embargoed-Final.pdf" target="_blank"><em><strong>remedial classes</strong></em></a><em>. Students may also take longer to complete their degrees if they fail some of their courses, change majors, face </em><a href="https://www.insidehighered.com/quicktakes/2012/08/29/huge-waiting-lists-california-community-colleges" target="_blank"><em><strong>waiting lists</strong></em></a><em> for required courses, or accumulate </em><a href="http://www.completecollege.org/docs/Time_Is_the_Enemy.pdf" target="_blank"><em><strong>excess credits</strong></em></a><em> without meeting all their graduation requirements.</em></p>
	...
	<h2>Tuition and Fees over Time</h2>
		...
		<p>For example, tuition at public four-year institutions increased, on average, 3.5 percent a year beyond general inflation between 2003&ndash;04 and 2008&ndash;09 and 4.9 percent a year between 2008&ndash;09 and 2013&ndash;14, compared with 1.3 percent a year for the past five years.</p>

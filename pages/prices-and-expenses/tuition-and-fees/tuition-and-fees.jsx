  ...
  <div>
    <h1>Tuition and Fees</h1>
		...
		<Box>
			...
			<p><em>The prices reported to the Department of Education and reflected in the sectoral averages do not necessarily incorporate this complexity.</em></p>
		</Box>
	<h2>Tuition and Fees by Sector</h2>
		<p>Media coverage of the few schools whose prices exceed $50,000 ignores the fact that prices at most colleges are lower. As shown below, tuition is <strong>highest at private nonprofit research universities</strong>,<strong> </strong>but even these schools had an average price of under $42,000 in 2015–16. </p>
		...
		<Box>
			...
			<p><em>The &ldquo;normal&rdquo; time to degree is four years for a bachelor&rsquo;s degree, two years for an associate degree, and less than two years for a certificate. If all students actually completed their degrees in these time periods, the sticker price of an associate degree would be twice the annual tuition and fees—an average of about $6,500 in community colleges and $30,400 </em><em>in the for-profit sector in 2016–17. The sticker price of a bachelor&rsquo;s degree would be four times the annual tuition and fees—an average of about $37,000 in the public sector, $60,700 at for-profit institutions, and $133,300</em><em> in the private nonprofit sector.</em></p>
	...
	<h2>Tuition and Fees Over Time</h2>
		...
		<p>For example, tuition at public four-year institutions increased, on average, about 7 percent per year beyond general inflation between 2001–02 and 2006–07 and about 5 percent per year between 2006–07 and 2011–12 compared with 2percent per year for the last five years.</p>
		<Box>
	...
	<h2>Distribution of Tuition and Fees within Sectors</h2>
		<p><strong>Tuition and fees vary within all sectors, but the differences are more significant in the private nonprofit sector.</strong></p>
		<p>In the public sector, variation in tuition and fees across institutions is explained primarily by <strong><a href="#variation_across_states">differences across states</a></strong> and by differences in institutional mission. Universities where faculty produce more research and teach more graduate students tend to charge the highest undergraduate tuition prices. </p>
		<p>In the private nonprofit sector, where individual institutions set their own prices, there is a much wider range of prices. There are large differences among private institutions in the type of education offered, the number of students and faculty members, the size of <a href="../../cost-of-educating/endowments/">endowments</a> and other private resources, and religious affiliations. Moreover, sticker prices depend on <a href="../../cost-of-educating/subsidies/">discounting practices</a>, which vary widely. At some private colleges, all or almost all students receive aid packages that save them from <a href="../../prices-and-expenses/net-price/">paying the full published price</a>. Other institutions might have lower sticker prices but more students paying full price. </p>
		<p>The differences in the private nonprofit sector, along with other sectors, are described in the figure below, which breaks full-time students into deciles based on the published tuition and fees charged by their institution. Although the median published tuition and fee price at private nonprofit institutions was $32,300 per year in 2014–15, students in the lowest decile were charged an average of $15,200—less than one-third of the $48,100 price tag for students in the top decile.</p>
		...
		<p>This chart also shows the smaller, but still significant, differences among colleges in other sectors. The average published tuition and fee price for full-time students in the top decile of public two-year colleges was $5,300—more than four times as high as the $1,200 annual price for students in the lowest decile.</p>
		<p>Ten percent of public four-year students attended institutions charging tuition and fees averaging $14,600 in 2014–15. The median sticker price in this sector was $8,500, but the average in the lowest decile was just $5,900. </p>
	<h2>Variation Across States</h2>
		...
		<p>Because of differences in the cost of living and the characteristics of the institutions, including selectivity, programs offered, <a href="../../cost-of-educating/endowments/">endowment levels</a>, size, and religious affiliation, prices at private colleges follow geographical patterns. For example, in 2015–16, the average <a href="../../definitions/">sticker price</a> in this sector was $40,700 in the Northeast compared to $28,500 in the South. But the differences are clearest in the public sectors, where state policies and student residency status play a big role.</p>
		<Graph file={require('./json/03_0040.json')}/>
		<p><em>In-State or In-District Tuition and Fees at Public Four-Year Colleges and Universities, by State, 2014–15</em></p>
		<p><strong>In 2014–15, published tuition and fees for in-state students at public four-year institutions ranged from $4,650 in Wyoming to $15,750 in Vermont.</strong> Twenty-three states charged at least $1,000 less than the national average of $9,450, and 15 states charged more than $1,000 above the national average. These differences arise primarily from variation in state funding levels, but they are also associated with enrollment patterns, cost of living, and other factors. </p>
  </div>
);

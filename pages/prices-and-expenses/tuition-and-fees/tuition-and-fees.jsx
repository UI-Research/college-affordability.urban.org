...
let singlepage = (
  <div>
    <h1>Tuition and Fees</h1>
		...
		<p>Sticker prices vary widely both <strong><a href="#tuition_and_fees_by_sector">across</a></strong> and <a href="#distribution_of_tuition_and_fees_within_sectors"><strong>within</strong></a> <a href="#distribution_of_tuition_and_fees_within_sectors"><strong>sectors</strong></a><strong> </strong>and, for public universities, <strong><a href="#variation_across_states">across states</a></strong>. And although sticker prices nationwide have increased <strong><a href="#tuition_and_fees_over_time">over time</a></strong>, the rate of increase has been different for different types of institutions. </p>
		<Box>

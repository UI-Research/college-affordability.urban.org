...
let singlepage = (
  <div>
    ...
    <h2>Institutions by Sector</h2>
      <p>In 2016&ndash;17, 6,606 postsecondary institutions were eligible to participate in federal financial aid programs and were required to provide data to the federal government. Of those, 4,360 (66 percent) were degree-granting institutions classified as public (37 percent), private nonprofit (39 percent), or for-profit ().</p>
      <Graph file={require('./json/010101.json')}/>
      <Box>
      <h3><em><strong>For-Profit Institutions</strong></em></h3>
      <p><em>Most college students are enrolled in public or private nonprofit colleges and universities. But for-profit institutions have come to play a significant role in postsecondary education. In 2016</em>&ndash;<em>17</em><em><strong> 1,055 (24 percent) of the 4,360</strong></em><em> degree-granting institutions participating in federal student aid </em><em>programs were for-profit. Most of these institutions are small, and together, they enrolled </em><em>undergraduate students.</em></p>
      ...
      <p><em>Between 2010 and 2016, </em><a href="https://nces.ed.gov/programs/digest/d17/tables/dt17_303.70.asp" target="_blank"><em><strong>undergraduate enrollment in the sector</strong></em></a><em> declined 47 percent from 1.7 to 0.9 million students. The decline in tuition in the sector is related to efforts to attract more </em><em>.</em></p>
    </Box>
      <p>Institution size varies significantly across sectors. Most for-profit institutions enroll fewer than 500 undergraduates each fall, but only 3 percent of public and 10 percent of private nonprofit institutions are so small. Eighty-two percent of public research universities enroll more than 5,000 undergraduates, but less than a quarter of public two-year colleges and only 20 percent of private nonprofit research universities are so large.</p>
    ...
    <h2>Enrollment by Sector</h2>
      ...
      <p>There were 19.4 million postsecondary students enrolled in degree-granting institutions in fall 2016. Of these, 16.7 million (86 percent) were undergraduate students. Among these undergraduates,</p>
      <ul>
        ...
        <li>16 percent were enrolled in private nonprofit four-year colleges, including research, master&rsquo;s, and bachelor&rsquo;s colleges and universities; and</li>
        <li>6 percent were enrolled in the for-profit .</li>
      </ul>
      <p>Enrollment patterns&mdash;whether students enroll full or part time&mdash;also differ by sector. Thirty-eight percent of college students enrolled part time in 2016&ndash;17, but 64 percent of students at public two-year colleges did so.</p>
      <Graph file={require('./json/010103.json')}/>
    <h2>Enrollment over Time</h2>
      <p>Total full-time equivalent undergraduate enrollment increased 13 percent between fall 1990 and fall 2000 and 41 percent between fall 2000 and fall 2010. It fell 4 percent, to 14.8 million, between 2010 and 2015.</p>

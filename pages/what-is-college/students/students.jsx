...
let singlepage = (
  <div>
    ...
    <h2>By Race and Ethnicity</h2>
      ...
      <p>A smaller share of black first-year students than of those from other groups enrolled in public two-year colleges in 2015&ndash;16. Black students were more likely than others to attend for-profit and non-degree-granting institutions.&nbsp;Five percent of black and 12 percent of Asian first-year students enrolled in private nonprofit colleges and universities.</p>
      <Graph file={require('./json/010208.json')}/>
    <h2>By Attendance Pattern</h2>
      <p>Forty-three percent of undergraduates are enrolled exclusively full time, and 12 percent are enrolled exclusively less than half time. More than 90 percent of students enrolled less than half time are in the public two-year sector, compared with 35 percent of those enrolled full time.</p>

...
let singlepage = (
  <div>
    ...
    <h2>Who Has Student Debt?</h2>
      ...
      <p>Although there are plenty of people juggling student debt with low incomes, because of the correlation between college education—and graduate education—and earnings, people with student debt are concentrated in the upper half of the income distribution. Households in the top 25 percent of the income distribution hold almost half of the outstanding education debt. Those in the lowest 25 percent hold only 11 percent of the debt.</p>
    ...
    <h2>By Sector</h2>
      ...
      <p>In 2011–12, for-profit colleges awarded over half all of undergraduate certificates, and the majority of students receiving them borrowed student loans.</p>
...
const DebtBurden = React.createClass({
  render: function() {
    return (
...
util.printToPage('debt-burden', DebtBurden);

module.exports = DebtBurden;

  ...
  <div>
    ...
    <h2>By Student Characteristics</h2>
      ...
      <h3>By Dependency Status</h3>
        ...
        <p>Independent students are allowed to borrow more than dependent students through the federal student loan program. Although more than half these students, according to National Postsecondary Student Aid Study 2016 data, attend community colleges with low tuition levels, they frequently use borrowed funds to cover a significant portion of their living expenses while they are in school.</p>
      ...
      <h3>By Race and Ethnicity</h3>
        ...
        <p>Patterns in debt burden by race and ethnicity are partially explained by differences in wealth and income. They also reflect other factors, such as dependency and age, as well as where students of different racial and ethnic backgrounds enroll. For example, black and Hispanic students are more likely to be older and independent, and black students were more likely than others to earn their bachelor&rsquo;s degrees in the for-profit sector in 2015&ndash;16.</p>

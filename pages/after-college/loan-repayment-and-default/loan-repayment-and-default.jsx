  ...
  <div>
    <h1>Loan Repayment and Default</h1>
      ...
      <Box>
        ...
        <p><em>The interest rates on federal student loans are legislated by Congress. The rate for undergraduates in 2018&ndash;19 was 5.05 percent. Rates are fixed for the life of the loan. Students who borrow $5,500 for the first year of college through direct unsubsidized loans, with interest accruing from the time the loans are made, will owe about $6,700 after four years if they don&rsquo;t make any payments while they are in school.</em></p>
    ...
    <h2>Repayment Plans</h2>
      ...
      <ul>
        <li><strong>Standard repayment plan.</strong> Payments are the same each month for 10 years or until the loan is paid off, whichever comes first. The minimum monthly payment is $50.</li>
        <li><strong>Graduated repayment plan.</strong> Monthly payments start out low and increase every two years. Loans are paid off within 10 years.</li>
        <li><strong>Extended repayment plan.</strong> Borrowers with high balances can extend their repayment time up to 25 years to allow for lower monthly payments.</li>
        <li>Income-driven plans. Four different plans, each with somewhat different provisions, base payments on current income and forgive unpaid balances after 20 or 25 years.
          <ul>
            <li><strong>Pay As You Earn, or PAYE.</strong> Borrowers pay 10 percent of their discretionary income but never more than they would pay under the standard repayment plan. Loan balances are forgiven after 20 years.</li>
            <li><strong>Revised Pay As You Earn, or REPAYE.</strong> Borrowers pay 10 percent of their discretionary income. Loan balances are forgiven after 20 years for those with only undergraduate loans and 25 years for those with graduate school loans.</li>
            <li><strong>Income-based repayment.</strong> Borrowers pay 10 or 15 percent of their discretionary income but never more than they would pay under the standard repayment plan. Loans are forgiven after 20 years.</li>
            <li><strong>Income-contingent repayment.</strong> Borrowers pay the lesser of 20 percent of their discretionary income or what they would pay under a 12-year repayment plan with fixed monthly payments. Loans are forgiven after 25 years.</li>
          </ul>
        </li>
      </ul>
    ...
    <h2>Delinquency, Default, and Repayment</h2>
      ...
      <Box>
        ...
        <p><em>The three-year default rate for borrowers entering repayment in 2013&ndash;14 was 11.5 percent, and the projected 20-year default rate for 2016&ndash;17 unsubsidized loans was 16.7 percent.</em></p>
      </Box>

...
const Graph = require('30-components/graphs/graph/graph.jsx'),
      ...
      SinglePage = require('30-components/singlepage/singlepage.jsx');
...
let singlepage = (
  <div>
    ...
    <Graph title="Education and related spending per student at public institution" file={require('./sample.js')} />
    ...
    <Graph title="Average endowment income per student within decile" file={require('./sample.js')} />
...
let specifications = {
  'name': 'producing-education-single',
...
util.printToPage('producing-education-single', ProducingEducation);

...
let singlepage = (
  <div>
    ...
    <h2>Net Worth</h2>
      ...
      <p><strong>Families headed by 45- to 54-year-olds—the most common age range for the parents of dependent college students—have higher net worth than other families, but their median wealth was almost 50 percent lower in 2013 than it was for similarly aged families in 2007.</strong></p>
    ...
    <h2>Demographic differences</h2>
      ...
      <p>For all types of families, the recession diminished net worth. Asset levels are lower than parents likely anticipated while they were saving for college. First-generation college students are less likely than others to have family resources to rely on to help them pay for college.</p>
      ...
      <h3>College Savings Accounts</h3>
        ...
        <p>These college savings accounts are most helpful to households in higher income tax brackets, because the value of tax deductions increases as the tax rate that would otherwise be applicable increases. Those whose incomes are too low to owe federal income taxes do not receive any added benefit from the tax-free status of the accounts. Moreover, the penalty for withdrawing funds for noncollege expenses creates a risk for families who do not know whether or not their children will go to college&mdash;making these accounts less desirable for lower-income families even if they can afford to save. <a href="http://www.taxpolicycenter.org/taxvox/what-can-we-learn-obamas-failure-curb-sec-529-college-savings-accounts" target="_blank">In fact</a>, these  accounts largely benefit students from higher income families, with only 3 percent of all households&mdash;but 20 percent of those earning more than $500,000&mdash;holding accounts</p>

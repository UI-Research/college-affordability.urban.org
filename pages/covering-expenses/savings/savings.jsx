...
let singlepage = (
  <div>
    <h1>Savings</h1>
      ...
      <p>The annual personal savings rate in the United States peaked at 13.5 percent of after-tax income in 1971 and 1973 and fell to 3.2 percent in 2005. After rising to 8.8 percent in 2012, the savings rate had fallen to 6.7 percent in 2018.</p>
    ...
    <h2>Net Worth</h2>
      ...
      <p><strong>Families headed by 45-to-54-year-olds&mdash;the most common age range for the parents of dependent college students&mdash;have higher net worth than other families, but, in 2016, their median wealth was more than 40 percent less than median wealth for similarly aged families in 2007.</strong></p>
    ...
    <h2>Demographic Differences</h2>
      <p><strong>In addition to having higher current incomes, non-Hispanic white families have greater assets, on average, to help pay for college than other families.</strong></p>
      <Graph file={require('./json/050205.json')}/>
      <p>For all families, the recession diminished net worth. Asset levels are lower than parents likely anticipated while they were saving for college.</p>
      <Graph file={require('./json/050206.json')}/>
      <p><strong>First-generation college students are less likely than others to have family resources to rely on to help them pay for college.</strong></p>

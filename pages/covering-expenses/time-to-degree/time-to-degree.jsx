...
let singlepage = (
  <div>
    <h1>Time to Degree </h1>
      ...
      <Multiples title="Tuition and Fees and Room and Board over Four, Five, and Six Years, 2016–17 Prices" source="National Postsecondary Student Aid Study 2012" source="Sandy Baum, Jennifer Ma, Matea Pender, and Meredith Welch, <em>Trends in Student Aid 2016 </em>(New York: College Board, 2016).">
        ...
        <p>Staying in school longer also means students forgo more <a href="../../prices-and-expenses/forgone-earnings">potential earnings</a>. Adding forgone earnings to tuition and fees and the cost of books and supplies gives the most accurate picture of the actual price of more time in college </p>

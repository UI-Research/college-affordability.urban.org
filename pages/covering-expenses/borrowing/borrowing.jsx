...
let singlepage = (
  <div>
    ...
    <h2>By Student Characteristics</h2>
      ...
      <Multiples title="Annual borrowing by student characteristics: averages per borrower and per undergraduate student (with percentage borrowing) in 2011-12" source="NPSAS, 2012.">

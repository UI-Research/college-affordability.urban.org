...
let singlepage = (
  <div>
    <h1>Institutional Subsidies</h1>
      ...
      <Multiples title="Education and Related Spending per Full-Time Equivalent Student at Public Institutions, 2005–06 to 2013–14, in 2014 Dollars" source="Jennifer Ma, Sandy Baum, Matea Pender, and Meredith Welch, <em>Trends in College Pricing 2016</em> (New York: College Board, 2016)." pluralSources="true">
    ...
    <h2>Distribution of Subsidies</h2>
      ...
      <Multiples title="Average Subsidy per Full-Time Equivalent Student within Undergraduate Deciles" source="Integrated Postsecondary Education Data System (IPEDS), 2015–16." notes=" Each decile includes 10 percent of the FTE undergraduate students enrolled in the sector, ordered from those attending the institutions with the lowest endowments per student to those attending institutions with the highest endowments per student.">

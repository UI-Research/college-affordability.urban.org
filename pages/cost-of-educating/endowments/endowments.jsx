...
let singlepage = (
  <div>
    ...
    <h2>Income from Endowments</h2>
      ...
      <Multiples title="Average Endowment Income per Student by Decile" source="Integrated Postsecondary Education Data System (IPEDS), 2013–14." notes="Institutions are sorted according to the Carnegie Classification of Institutions of Higher Education framework. FTE = full-time equivalent." pluralNotes="true">

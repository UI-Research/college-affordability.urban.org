...
Please note that everything within `data_scripts` is copied over from the [ed-data](https://github.com/UrbanInstitute/ed-data) repo.
...
* [Setting up your machine](docs/setup.md)
* [Working with IPEDS data](docs/ipedsdata.md)
* [Creating graph jsons](docs/graphcreation.md)

    ...
    <div className='data-viz'>
      ...
      <div className="grid">
        ...
        <div className="col col--3-4">
          ...
          <p>Public research universities spend almost 50% more per student than public masterâ€™s universities, and
          ...
          <CaptionTop>
            <p>Institutional subsidies are the share of the total cost that is covered by the institution rather than by the
              studentâ€™s tuition. In the public sector, these subsidies come primarily from state and local tax revenues. In
